...
class SchoolTeensPage extends StatelessWidget {
  const SchoolTeensPage({super.key});
...
class HorizontallyScrollableCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 220, // Adjust the height of the cards container
      child: Padding(
